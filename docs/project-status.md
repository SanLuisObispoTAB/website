...
> **Last updated:** 2026-06-16 *(AD confirmed the spirit squads: Dance + Competitive Cheer are both Fall, STUNT is girls-only Spring, nothing in Winter — applied in #83, resolving E16; earlier today #74–#82)*
>
...
| ~~E16~~ | ~~Spirit-squad structure — distinct teams? official names + genders?~~ | ~~AD~~ | ✅ Resolved 2026-06-16 (#83) — AD confirmed: Fall = Girls Dance + Competitive Cheer; Winter = none; Spring = STUNT (girls-only, all-caps). Only Competitive Cheer's gender left unstated (kept Co-ed) |
