...
> **Last updated:** 2026-08-16 *(🚀 **slotab.org is LIVE on the new site** — DNS cutover complete and verified end to end; the ravens-peak alias correctly stays `noindex` in production — #114. Open: flip Vercel's primary domain to the apex, Search Console, the paired OAuth/`base_url` swap, delete three stale Cloudflare ACME records, cancel GoDaddy hosting after 48h, and **confirm domain auto-renew before 2026-09-19**.)*
>
