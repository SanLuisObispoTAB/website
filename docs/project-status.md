...
> **Last updated:** 2026-08-11 *(Step-by-step cutover runbook at `docs/dns-cutover-runbook.md`, written against the verified Vercel account state — #102. Earlier: cookie consent + analytics (#101); cutover code side, host-aware indexing (#100) — **DNS itself still pending, Erik-side**; #94–#99.)*
>
...
| Item | Owner | Notes |
|---|---|---|
| 🔴 **Real Impact ledger data** | Treasurer (Trina) | **Launch-blocking for `/impact`.** The 24 draft line items were cleared 2026-08-11 (#94); the page shows a "being compiled" note until real purchases land. Enter at /admin → Impact Ledger; totals, grouping, and filters light up automatically |
