...
> **Last updated:** 2026-06-16 *(Girls Flag Football team page + official portrait swap; cleared the staging-dir photo backlog; added a `photo-inbox/` + `npm run photo-intake` audit/resize helper so it can't reaccumulate — #74–#77)*
>
