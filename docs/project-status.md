...
> **Last updated:** 2026-05-29 *(security audit + hardening pass over the API attack surface — Decap OAuth scope cut to `public_repo`, HSTS added, Springly routes stop leaking upstream errors; rate-limiting + CSP deferred to infra — #73)*
>
