...
> **Last updated:** 2026-05-28 *(13 more 2025-26 photos staged + beach-VB carousel slot upgraded — #70; `/teams` index now blooms a photo strip on each card as you scroll between seasons — #71; 8 portrait→action swaps across the shared photo map — #72)*
>
