...
> **Last updated:** 2026-06-16 *(Girls Flag Football team page + official portrait swap; cleared the staging-dir photo backlog; added a `photo-inbox/` + `npm run photo-intake` audit/resize helper, now with an interactive `--rename` step that suggests convention names — #74–#78)*
>
...
| Teams index | `/teams` | ✅ — all 27 programs, 5 with active pages |
...
- [ ] Build out the other 22 team pages once they have content
